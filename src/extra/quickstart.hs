...
-- testParser "x := 10; while (not(x == 1)) do x := x - 1;" == ("","x=1")
-- simple while statement



-- testParser "i := 10; fact := 1; while (not(i == 1)) do (if (2*6 == 12 and True = True) then (fact := fact * i; i := i - 1;) else x := 0;);" == ("","fact=3628800,i=1")